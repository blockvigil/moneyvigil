...
The uses the default [Sapper](https://github.com/sveltejs/sapper) template, with branches for Rollup and webpack. To clone it and get started:
...
You can pass environment values to customize the app and API endpoints. Refer to `rollup.config.js`.
